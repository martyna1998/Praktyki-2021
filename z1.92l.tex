...
%[x1]=int([p1]/[m])
%[x2]=int([p2]/[m])
%[a]!=[b] and ([e]-[c])!=0 and ([n1]/[n2])<([f]/[e]) and [m2]!=1 and [n2]!=1 and [g]>0 and math.gcd([a],[b])==1 and [p1]!=0 and ([p2]*[c])!=([d]*[p1]) and ([p2]*[e])!=([f]*[p1]) and ([e]*([a]*[d]+[b]*[f]-[a]*[f])-([f]*([b]*[e]+[a]*[c]-[a]*[e])))>0 and ([c]*([a]*[d]+[b]*[f]-[a]*[f])-([d]*([b]*[e]+[a]*[c]-[a]*[e])))<([e]*([a]*[d]+[b]*[f]-[a]*[f])-([f]*([b]*[e]+[a]*[c]-[a]*[e]))) and ([e]*([a]*[d]+[b]*[f]-[a]*[f])-([f]*([b]*[e]+[a]*[c]-[a]*[e])))>0 and [x1]!=1
