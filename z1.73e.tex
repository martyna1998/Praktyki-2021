...
%[bpd]=[b]+[d]
%[cpd]=[c]+[d]
%[delta]=([bpd]*[bpd])+(4*[amd]*[cpd])
%[pierw]=math.sqrt(abs([delta]))
%[pierw1]=int([pierw])
%[x1]=round([bpd]-[pierw1]/2*[amd],2)
%[x2]=round([bpd]+[pierw1]/2*[amd],2)
%[apd]=[a]+[d]
%[mbpd]=-[b]+[d]
%[mcpd]=-[c]+[d]
%[d]>[a] and [amd]!=-1 and [delta]>0 and [pierw].is_integer() and [amd]!=0 and [mbpd]>1 and [mcpd]>0
